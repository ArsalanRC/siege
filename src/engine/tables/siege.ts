/**
 * SIEGE: the castle board, as data.
 *
 ...
 *
 * The parts every board shares live in `../table.ts`. This file is the castle,
 * and every number in it came off the painting.
 *
 ...
 */
const FLIPPER_PIVOT_LEFT: Vec = vec(339, 1288);
const FLIPPER_PIVOT_RIGHT: Vec = vec(654, 1288);
 ...
 * level constant.
 */
export function buildSiege(): Table {
  resetIds();
